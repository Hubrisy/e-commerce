...
const SuccessPage = () => {
  ...
  return (
    <div className="max-w-[340px] m-auto mt-[128px] mb-10 md:flex md:max-w-[80%] flex-row-reverse justify-between xl:max-w-[1100px]">
      <div className="text-center md:mt-12 md:ml-4">
        <div className="text-center text-2xl font-medium">
          Thanks for your purchase!❤️
        </div>
        <div className="mt-2 font-medium text-[16px]">
